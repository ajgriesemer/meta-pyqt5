...
do_configure_prepend_class-target() {
    ...
    echo "py_inc_dir = %(sysroot)/${includedir}/${PYTHON_DIR}${PYTHON_ABI}" >> sip.cfg
    echo "sip_bin_dir = ${D}/${bindir}" >> sip.cfg
    echo "sip_inc_dir = ${D}/${includedir}" >> sip.cfg
    echo "sip_module_dir = ${D}/${PYTHON_SITEPACKAGES_DIR}" >> sip.cfg
...
do_configure_prepend_class-native() {
    echo "py_platform = linux" > sip.cfg
    echo "py_inc_dir = ${includedir}/${PYTHON_DIR}${PYTHON_ABI}" >> sip.cfg
    echo "sip_bin_dir = ${D}/${bindir}" >> sip.cfg
    echo "sip_inc_dir = ${D}/${includedir}" >> sip.cfg
    echo "sip_module_dir = ${D}/${PYTHON_SITEPACKAGES_DIR}" >> sip.cfg
    echo "sip_sip_dir = ${D}/${datadir}/sip" >> sip.cfg
...
FILES_python3-sip += "${PYTHON_SITEPACKAGES_DIR}/"
